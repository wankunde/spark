...
# 2. update mvn build command
BUILD_COMMAND=("$MVN" clean install -DskipTests -Phive -Phive-thriftserver -Pyarn -Pcdhhive -pl core -am $@)
...
"${BUILD_COMMAND[@]}"
cp core/target/spark-core_2.12-3.0.0.leyan.jar assembly/target/scala-2.12/jars/spark-core_2.12-3.0.0.leyan.jar
